...
// Dialog Data
	...
	CStatic	m_PhyMemAvailStatic;
	CStatic	m_MemUseStatic;
	CStatic	m_PhysicalMemStatic;
	CStatic	m_VirtualMemStatic;
	CStatic	m_VendorStatic;
	CStatic	m_CPUSpeedStatic;
	...
	CString	m_stCPUSpeed;
	CString	m_stVendorInfo;
	CString	m_stMemoryUsed;
	CString	m_stPhysicalMemory;
	CString	m_stVirtualMemory;
	CString	m_stPhysicalMemAvailable;
	//}}AFX_DATA
