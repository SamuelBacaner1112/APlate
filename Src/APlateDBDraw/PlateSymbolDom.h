...
// PlateSymbolDom.h: interface for the CPlateSymbolDom class.
//
//////////////////////////////////////////////////////////////////////

#if !defined(AFX_PLATESYMBOLDOM_H__A8C6F54B_4A0D_4FB5_BCB0_3C4100D7B144__INCLUDED_)
#define AFX_PLATESYMBOLDOM_H__A8C6F54B_4A0D_4FB5_BCB0_3C4100D7B144__INCLUDED_
...
class CDataManage;
class AFX_EXT_CLASS CAPlateSymbolDom : public CDomyun  
{
public:
	CAPlateSymbolDom(CDomyun *pDom, CDataManage *pDataMng);
	virtual ~CAPlateSymbolDom();
private:
...
public:	
	...
	void DrawWeldMark(CDPoint xy,long nMarkBuje1, long nMarkBuje2, CPlateBasicIndex *pBx, double dWeldSize, double dHeight1, double dHeight2, BOOL bLeft, BOOL bUpper, double dAngle, BOOL bFrontFace = TRUE, CString szAddStr = "", BOOL bGrind=TRUE, BOOL bSttSplice=FALSE, BOOL bFlag=FALSE, BOOL bUpperSide=TRUE, long nIdx = -99);
	...
	void DrawSymbolSectionGisiArrow(CDPoint xy, double dDis, CString strTitle1, CString strTitle2, double dRotAng = 0);
...
#endif // !defined(AFX_PLATESYMBOLDOM_H__A8C6F54B_4A0D_4FB5_BCB0_3C4100D7B144__INCLUDED_)
