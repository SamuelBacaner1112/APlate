...
BEGIN_MESSAGE_MAP(TStackedPage, CXTResizeDialog)
//{{AFX_MSG_MAP(TStackedPage)
//}}AFX_MSG_MAP
END_MESSAGE_MAP()

TStackedPage::TStackedPage(UINT nID, CWnd* pParent)
...
//
//=============================================================================
IMPLEMENT_DYNAMIC(TStackedDialog,CDialog);

BEGIN_MESSAGE_MAP(TStackedDialog, CGeneralBaseDlg)
	//{{AFX_MSG_MAP(TStackedDialog)
	ON_WM_DESTROY()
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()

TStackedDialog::TStackedDialog(UINT nPlaceholder, UINT nID, CWnd* pParent)
	: CGeneralBaseDlg(nID, pParent)
{
	init(nPlaceholder);
}
